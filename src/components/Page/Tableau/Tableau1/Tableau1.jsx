...
export default function Tableau1(props) {
    ...
    const [datatravaux, setdatatravaux] = useState(
        [
            {
                nomclasse: 'L1',
                details:
                    ...
                    <div className='grid h-full ' id='imprimable'  >
                        ...
                        <table title='Tableau A' className='pt-5' style={{ borderCollapse: 'collapse', width: '79.3148%', height: '156.75px', marginLeft: 'auto', marginRight: 'auto' }} border={1}><colgroup><col style={{ width: '14.8783%' }} /><col style={{ width: '12.9847%' }} /><col style={{ width: '13.0748%' }} /><col style={{ width: '18.936%' }} /><col style={{ width: '14.9684%' }} /><col style={{ width: '12.7142%' }} /><col style={{ width: '12.4436%' }} /></colgroup>
                            ...
                            <tbody>
                                ...
                                <tr >
                                    <td style={{ height: '117.563px', textAlign: 'center' }} rowSpan={datasem.length + 8}>TABLEAU A { } </td>
                                    <td style={{ height: '117.563px', textAlign: 'center' }} rowSpan={datasem.length + 8}>RPM</td>
                        ...
                        <table title='Tableau B' style={{ borderCollapse: 'collapse', width: '79.1732%', height: '185.969px', marginLeft: 'auto', marginRight: 'auto' }} border={1}><colgroup><col style={{ width: '14.9041%' }} /><col style={{ width: '12.981%' }} /><col style={{ width: '13.0771%' }} /><col style={{ width: '18.9426%' }} /><col style={{ width: '15.0002%' }} /><col style={{ width: '12.6925%' }} /><col style={{ width: '12.404%' }} /></colgroup>
