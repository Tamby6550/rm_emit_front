...
export default function InsertionProff(props) {
    ...
    const onSub = async () => {
        ...
        try {
            ...
            await axios.post(props.url + `ajoutProff`,infoProff, {
                headers: {
    ...
    return (
        <div>
            <Button icon={PrimeIcons.PLUS_CIRCLE} tooltip='Nouveau' tooltipOptions={{ position: 'top' }} label='Nouveau Proffesseur' className=' mr-2 p-button-primary' onClick={() => { onClick('displayBasic2');  }} />
